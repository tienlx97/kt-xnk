      ...
      <VStack gap={0}>
        <VStack gap={2} paddingBlock={2}>
          ...
          <Text type="large" color="secondary">
            Component thật từ <code>@astryxdesign/core</code>, đã nối màu thương
            hiệu kt-xnk qua <code>src/shared/components/theme.js</code>: accent
            và nút secondary dùng đúng màu teal/đỏ lấy từ logo, còn toàn bộ nền
            — chữ — viền chạy trên một dải trung tính cùng tông teal (cách
            react.dev dựng palette của họ). Trang này không phải trang nội dung
